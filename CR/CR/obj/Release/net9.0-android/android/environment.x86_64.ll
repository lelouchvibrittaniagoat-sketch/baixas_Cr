...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 u0x06001ad8, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001ad7, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [927 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x2d42f1eb95c39fcf, ; from name: aot-CR.dll.so
		i64 u0xe45f89d6b6354a37, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CR.dll.so
		ptr null; void* handle
	}, ; 147
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x531be792a0dca47d, ; from name: aot-CR
		i64 u0xe45f89d6b6354a37, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CR.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x5e45c49ad33ff4e2, ; from name: CR.dll.so
		i64 u0xe45f89d6b6354a37, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CR.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x7b654ffe0a0d3041, ; from name: aot-CR.so
		i64 u0xe45f89d6b6354a37, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CR.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x82c9f30d3f66ff38, ; from name: libaot-CR
		i64 u0xe45f89d6b6354a37, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CR.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xa656056908117eac, ; from name: CR.so
		i64 u0xe45f89d6b6354a37, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CR.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xe45f89d6b6354a37, ; from name: libaot-CR.dll.so
		i64 u0xe45f89d6b6354a37, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CR.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf98af946f286b6d9, ; from name: CR
		i64 u0xe45f89d6b6354a37, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CR.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xff2b0cb30545bb00, ; from name: libaot-CR.so
		i64 u0xe45f89d6b6354a37, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CR.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [19 x i8] c"com.companyname.cr\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [17 x i8] c"libaot-CR.dll.so\00", align 16
